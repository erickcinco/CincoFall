 ...
 */
#define HOST_IP_ADDR           0xC0A8010A               // IP address of server to connect to
 ...
 */
#define CONFIG_IP       SL_IPV4_VAL(192,168,1,10)       /* Static IP to be configured */
...
#define AP_DNS          SL_IPV4_VAL(8,8,8,8)            /* DNS Server Address */
